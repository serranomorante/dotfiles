...
local groups = {
  ...
  CustomAgentUnfirejailedTabLine = {
    fg = background == "dark" and "White" or "Black",
    bg = background == "dark" and "#5c0000" or "#ff7a7a",
    bold = true,
  },
  CustomAgentUnfirejailedTabLineSel = {
    fg = background == "dark" and "White" or "Black",
  ...
  CustomTerminalModeNormal = {
    fg = background == "dark" and "Black" or "White",
    bg = fg .. "Yellow",
    bold = true,
  },
  CustomTerminalModeInsert = { fg = background == "dark" and "#9a9a9a" or "#6a6a6a" },
  CustomTerminalDim = { fg = background == "dark" and "#9a9a9a" or "#6a6a6a" },
  CustomTerminalStatusActive = { fg = fg .. "Cyan" },
  CustomTerminalStatusOk = { fg = fg .. "Green" },
  CustomTerminalStatusWarn = { fg = fg .. "Yellow" },
  CustomTerminalStatusErr = { fg = fg .. "Red" },
