  ...
  dap.configurations.sh = {
    {
      ...
      pathBashdb = vim.env.HOME .. "/data/apps/lang-tools/bash-debug-adapter/extension/bashdb_dir/bashdb",
      pathBashdbLib = vim.env.HOME .. "/data/apps/lang-tools/bash-debug-adapter/extension/bashdb_dir",
      trace = true,
